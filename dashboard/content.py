...
LANGS = {
    "English": {
        ...
        "demo_banner_title": "Demo workspace active",
        "load_error": "The dashboard could not load curated gold datasets.",
        "loading": "Loading curated revenue workspace...",
        "workspace_kicker": "Workspace context",
        "workspace_chip": "Portfolio-ready operating view",
        "workspace_source_copy": "Current source feeding the executive workspace.",
        "workspace_periods_title": "Revenue periods",
        "workspace_periods_copy": "Curated monthly slices available for analysis.",
        "workspace_customers_title": "Tracked customers",
        "workspace_customers_copy": "Customer 360 profiles available in the current source.",
        "share_state_title": "Share current view",
        "share_state_copy": (
            "Use the query string below or download the state snapshot for this view."
        ),
        "share_state_download": "Download view state",
        ...
        "executive_briefing_title": "Executive briefing",
        "executive_briefing_copy": "Narrative summary generated from the currently filtered view.",
        "export_briefing": "Download briefing",
        "export_monthly_view": "Download filtered revenue view",
        "delta_up": "up",
        "delta_down": "down",
        "delta_flat": "flat",
        ...
        "cohort_spotlight_title": "Cohort spotlight",
        "cohort_spotlight_select": "Select cohort",
        "cohort_benchmark_title": "Cohort benchmark",
        "export_cohort_spotlight": "Download cohort spotlight",
        ...
        "customer_spotlight_title": "Customer spotlight",
        "customer_spotlight_select": "Select customer",
        "export_customer_spotlight": "Download customer spotlight",
        "export_customer_view": "Download filtered customer view",
        "export_customer_risk": "Download at-risk customers",
        ...
        "run_spotlight_title": "Run spotlight",
        "run_spotlight_select": "Select run",
        "export_run_compare": "Download run comparison",
        "export_run_spotlight": "Download run spotlight",
    ...
    "Portuguese": {
        ...
        "demo_banner_title": "Workspace demo ativo",
        "load_error": "O dashboard nao conseguiu carregar os datasets gold curados.",
        "loading": "Carregando workspace de receita curado...",
        "workspace_kicker": "Contexto do workspace",
        "workspace_chip": "Visao operacional pronta para portfolio",
        "workspace_source_copy": "Fonte atual alimentando o workspace executivo.",
        "workspace_periods_title": "Periodos de receita",
        "workspace_periods_copy": "Recortes mensais curados disponiveis para analise.",
        "workspace_customers_title": "Clientes monitorados",
        "workspace_customers_copy": "Perfis Customer 360 disponiveis na fonte atual.",
        "share_state_title": "Compartilhar visao atual",
        "share_state_copy": "Use a query string abaixo ou baixe o snapshot de estado desta visao.",
        "share_state_download": "Baixar estado da visao",
        ...
        "executive_briefing_title": "Briefing executivo",
        "executive_briefing_copy": "Resumo narrativo gerado a partir da visao filtrada atual.",
        "export_briefing": "Baixar briefing",
        "export_monthly_view": "Baixar visao filtrada de receita",
        "delta_up": "alta",
        "delta_down": "queda",
        "delta_flat": "estavel",
        ...
        "cohort_spotlight_title": "Detalhe do cohort",
        "cohort_spotlight_select": "Selecione o cohort",
        "cohort_benchmark_title": "Benchmark do cohort",
        "export_cohort_spotlight": "Baixar detalhe do cohort",
        ...
        "customer_spotlight_title": "Detalhe do cliente",
        "customer_spotlight_select": "Selecione o cliente",
        "export_customer_spotlight": "Baixar detalhe do cliente",
        "export_customer_view": "Baixar visao filtrada de clientes",
        "export_customer_risk": "Baixar clientes em risco",
        ...
        "run_spotlight_title": "Detalhe do run",
        "run_spotlight_select": "Selecione o run",
        "export_run_compare": "Baixar comparacao de runs",
        "export_run_spotlight": "Baixar detalhe do run",
    ...
    "Spanish": {
        ...
        "demo_banner_title": "Workspace demo activo",
        "load_error": "El dashboard no pudo cargar los datasets gold curados.",
        "loading": "Cargando workspace curado de ingresos...",
        "workspace_kicker": "Contexto del workspace",
        "workspace_chip": "Vista operativa lista para portafolio",
        "workspace_source_copy": "Fuente actual que alimenta el workspace ejecutivo.",
        "workspace_periods_title": "Periodos de ingresos",
        "workspace_periods_copy": "Cortes mensuales curados disponibles para analisis.",
        "workspace_customers_title": "Clientes monitoreados",
        "workspace_customers_copy": "Perfiles Customer 360 disponibles en la fuente actual.",
        "share_state_title": "Compartir vista actual",
        "share_state_copy": "Usa el query string de abajo o descarga el snapshot de esta vista.",
        "share_state_download": "Descargar estado de la vista",
        ...
        "executive_briefing_title": "Briefing ejecutivo",
        "executive_briefing_copy": "Resumen narrativo generado desde la vista filtrada actual.",
        "export_briefing": "Descargar briefing",
        "export_monthly_view": "Descargar vista filtrada de ingresos",
        "delta_up": "sube",
        "delta_down": "baja",
        "delta_flat": "estable",
        "delta_vs_prior": "vs mes anterior",
        ...
        "cohort_spotlight_title": "Detalle de cohorte",
        "cohort_spotlight_select": "Selecciona cohorte",
        "cohort_benchmark_title": "Benchmark de cohorte",
        "export_cohort_spotlight": "Descargar detalle de cohorte",
        ...
        "customer_spotlight_title": "Detalle del cliente",
        "customer_spotlight_select": "Selecciona cliente",
        "export_customer_spotlight": "Descargar detalle del cliente",
        "export_customer_view": "Descargar vista filtrada de clientes",
        "export_customer_risk": "Descargar clientes en riesgo",
        "customer_priority": "Clientes prioritarios",
        ...
        "run_spotlight_title": "Detalle del run",
        "run_spotlight_select": "Selecciona run",
        "export_run_compare": "Descargar comparacion de runs",
        "export_run_spotlight": "Descargar detalle del run",
        "run_catalog_title": "Catalogo de runs",
