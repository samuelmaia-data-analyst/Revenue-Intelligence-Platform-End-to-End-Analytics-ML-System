...
I18N = {
    ...
    "pt-br": {
        ...
        "risk_line": "<b>Risco:</b> {segment} e o segmento mais exposto ({risk:.1%}).",
        ...
        "action_distribution": "Distribuicao de Acoes",
        "channel_efficiency": "Eficiencia por Canal (LTV/CAC)",
        "cohort_retention": "Retencao por Coorte (%)",
        "months_since": "Meses desde aquisicao",
        "cohort_label": "Coorte de aquisicao",
        "retention": "Retencao %",
        "model_source": "Fonte: data/processed/executive_report.json",
        "churn_model": "Churn",
        "next_model": "Proxima Compra 30d",
        "split": "Split",
        "cv_auc": "ROC-AUC CV",
        "holdout_auc": "ROC-AUC Holdout",
        "churn_by_segment": "Risco de Churn por Segmento",
        "next_by_channel": "Prob. de Proxima Compra por Canal",
        "drivers": "Drivers de Risco: Recency vs Churn (bolha = Frequency)",
        "business_ltv_cac": "LTV/CAC Medio",
        ...
        "business_net_impact_sub": "net impact 90d",
        "simulation": "Simulacao de Efeito (Top-10)",
        "baseline": "Baseline 90d",
        "scenario": "Scenario 90d",
        ...
        "top_actions": "Top-10 Acoes Priorizadas",
    },
}
