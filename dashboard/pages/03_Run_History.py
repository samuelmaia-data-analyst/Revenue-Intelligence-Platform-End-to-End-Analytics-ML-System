...
from dashboard.data_access import load_dashboard_data, load_run_history, resolve_dashboard_sources
from dashboard.views import render_run_history
...
def main() -> None:
    ...
    render_workspace_strip(
        labels,
        page_title=labels["nav_run_history"],
        page_copy=labels["run_history_copy"],
        source_label=(
